...
export default {
  editorKey: 'default',
  locale: 'pt-BR', // Mudado de zh-CN para pt-BR
  theme: 'light',
  skin: 'default',
  height: '100%',
  fullscreenZIndex: 10,
  ...
  document: {
    ...
    placeholder: {
      ...
      zh_CN: '请输入文档内容...',
      pt_BR: 'Comece a digitar aqui...', // Adicionado pt_BR
    },
    structure: 'block+',
  ...
  webPages: [
    {
      label: {
        zh_CN: '哔哩哔哩',
        en_US: 'Bilibili',
        pt_BR: 'Bilibili', // Adicionado pt_BR
      },
    ...
    },
    {
      label: {
        zh_CN: '墨刀',
        en_US: 'MockingBot',
        pt_BR: 'MockingBot', // Adicionado pt_BR
      },
    ...
    },
    {
      label: {
        zh_CN: '腾讯视频',
        en_US: 'Tencent Video',
        pt_BR: 'Tencent Video', // Adicionado pt_BR
      },
